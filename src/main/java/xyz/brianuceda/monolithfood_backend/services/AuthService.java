...
import xyz.brianuceda.monolithfood_backend.dtos.auth.LoginRequestDTO;
import xyz.brianuceda.monolithfood_backend.dtos.auth.RegisterRequestDTO;
...
import xyz.brianuceda.monolithfood_backend.repositories.IpLoginAttemptRepository;
import xyz.brianuceda.monolithfood_backend.repositories.RoleRepository;
...
public class AuthService {
    ...
    public ResponseDTO register(RegisterRequestDTO request) {
        try {
            ...
            String token = jwtUtils.genToken(user, profileStage);
