        ...
        return args -> {
            ...
            if(nutrientRepository.count() == 0) {
                nutrients = Arrays.asList(
                    new NutrientEntity(null, "Calorias", "Unidad de medida de energia que se obtiene de los alimentos.", "Las calorías provienen principalmente de los macronutrientes: proteínas, carbohidratos y grasas. El valor calórico indica la cantidad de energía almacenada en los alimentos.", null),
                    new NutrientEntity(null, "Proteina", "Macronutriente esencial para la construccion de masa muscular.", "Las proteínas están formadas por aminoácidos. Son importantes para la síntesis y reparación muscular, además de funciones enzimáticas, hormonales e inmunológicas.", null),
                    new NutrientEntity(null, "Grasa", "Macronutriente esencial para la energia.", "Los lípidos o grasas son fuente concentrada de energía. También ayudan en la absorción de vitaminas liposolubles y forman parte de las membranas celulares.", null),
                    new NutrientEntity(null, "Carbohidratos", "Principal fuente de energia.", "Los carbohidratos o glucidos proporcionan glucosa que es la principal fuente de energía para las células. Pueden ser simples (azúcares) o complejos (almidones).", null),
                    new NutrientEntity(null, "Vitamina B6", "Vitamina esencial para el metabolismo.", "La vitamina B6 participa en el metabolismo de proteínas, glucidos y grasas. Contribuye a la síntesis de neurotransmisores y hemoglobina.", null),
                    new NutrientEntity(null, "Fosforo", "Mineral esencial para la salud osea.", "El fósforo forma parte de huesos y dientes, también participa en el metabolismo energético, la contracción muscular y el equilibrio ácido-base.", null),
                    new NutrientEntity(null, "Magnesio", "Mineral esencial para diversas funciones biologicas.", "El magnesio participa en más de 300 reacciones enzimáticas del metabolismo energético, síntesis proteica, contracción muscular y neurotransmisión. Ayuda a regular la glucosa y la presión arterial.", null),
                    new NutrientEntity(null, "Vitamina C", "Antioxidante y esencial para la salud inmunologica.", "La vitamina C es un potente antioxidante que protege contra el daño oxidativo. También participa en la formación de colágeno, absorción de hierro y funcionamiento del sistema inmunológico.", null),
                    new NutrientEntity(null, "Vitamina K", "Vitamina esencial para la coagulacion de la sangre.", "La vitamina K es necesaria para la síntesis de protrombina, un factor de coagulación sanguínea. También parece estar implicada en la salud ósea y prevención del calcio en arterias.", null),
                    new NutrientEntity(null, "Fibra", "Mejora la digestion y reduce el colesterol.", "La fibra dietética acelera el tránsito intestinal, prolonga la sensación de saciedad y facilita la eliminación. Algunas fibras soluble reducen la absorción de grasas y azúcares.", null),
                    new NutrientEntity(null, "Azucares", "Carbohidratos simples que proporcionan energia.", "Los azúcares o hidratos de carbono simples como glucosa, fructosa y sacarosa aportan energía de rápida absorción. Su exceso se transforma en grasa y puede causar caries dental.", null),  
                    new NutrientEntity(null, "Calcio", "Fortalece los huesos y dientes.", "El calcio es el mineral más abundante en el cuerpo. Es esencial para formar y mantener la densidad ósea, coagulación, contracción muscular y neurotransmisión.", null),
                    new NutrientEntity(null, "Hierro", "Transporta oxigeno en la sangre.", "El hierro forma parte de la hemoglobina permitiendo el transporte de oxígeno en los glóbulos rojos. Su deficiencia produce anemia.", null),
                    new NutrientEntity(null, "Potasio", "Ayuda en la transmision nerviosa.", "El potasio es un electrolito necesario para la transmisión del impulso nervioso, contracción muscular y balance de fluidos. Se encuentra en frutas, verduras, carnes y lácteos.", null),  
                    new NutrientEntity(null, "Zinc", "Fortalece el sistema inmunologico.", "El zinc participa en el funcionamiento de más de 100 enzimas. Ayuda en la división celular, cicatrización, síntesis de proteínas y respuesta inmunológica.", null),
                    new NutrientEntity(null, "Vitamina D", "Vitamina esencial para la salud de los huesos.", "La vitamina D mejora la absorción de calcio y fósforo contribuyendo a la mineralización ósea. También posee acciones inmunomoduladoras.", null),
                    new NutrientEntity(null, "Vitamina B12", "Vitamina esencial para la formacion de globulos rojos.", "La vitamina B12 participa en la hematopoyesis, síntesis de ADN y metabolismo energético. Su deficiencia produce anemia megaloblástica.", null),
                    new NutrientEntity(null, "Omega 3", "acido graso esencial beneficioso para la salud cardiovascular.", "Los ácidos grasos omega 3 EPA y DHA previenen la inflamación y mejoran los niveles de triglicéridos, presión arterial y ritmo cardíaco.", null),
                    new NutrientEntity(null, "Selenio", "Mineral esencial con propiedades antioxidantes.", "El selenio forma parte de enzimas antioxidantes que protegen las membranas celulares del daño oxidativo. También mejora la respuesta inmune.", null),
                    new NutrientEntity(null, "Aminoacidos BCAA", "Aminoacidos de cadena ramificada que promueven la recuperacion muscular.", "Los aminoácidos BCAA (valina, leucina e isoleucina) estimulan la síntesis proteica, disminuyen el daño muscular post-ejercicio y retardan la fatiga.", null),
                    new NutrientEntity(null, "Colina", "Nutriente esencial importante para la funcion cerebral y la salud hepatica.", "La colina es precursora de la acetilcolina, un neurotransmisor. También participa en el metabolismo de grasas evitando la acumulación en el hígado.", null),
                    new NutrientEntity(null, "Alcohol", "Calorias derivadas del consumo de alcohol.", "El alcohol etílico aporta 7 kcal/gramo. Su consumo excesivo es tóxico para el hígado y el sistema nervioso central. Debe consumirse con moderación.", null),
                    new NutrientEntity(null, "Capsaicina", "Compuesto picante presente en los pimientos.", "La capsaicina estimula receptores de calor que incrementan el gasto energético. Parece tener propiedades anticancerígenas, analgésicas y antiinflamatorias.", null),
                    new NutrientEntity(null, "Fructosa", "Tipo de azucar natural presente en las frutas.", "La fructosa es un azúcar simple que se encuentra en frutas y miel. Es más dulce que la sacarosa pero tiene un índice glucémico bajo.", null),
                    new NutrientEntity(null, "Glucosa", "Azucar simple que es una fuente de energia inmediata para el cuerpo.", "La glucosa es el principal carbohidrato que circula en la sangre y provee energía a las células. Su elevación sostenida produce diabetes.", null),
                    new NutrientEntity(null, "Sacarosa", "Azucar de mesa comun.", "La sacarosa o azúcar común es un disacárido compuesto por glucosa y fructosa. Su consumo excesivo se asocia a caries dental, sobrepeso y diabetes.", null),
                    new NutrientEntity(null, "Folato", "Vitamina B importante para la sintesis del ADN y el crecimiento celular.", "El folato participa en la producción de ácidos nucleicos y aminoácidos. Su deficiencia en el embarazo causa defectos del tubo neural.", null),
                    new NutrientEntity(null, "Vitamina A", "Vitamina esencial para la vision y la salud de la piel.", "La vitamina A es esencial para la visión nocturna y la diferenciación celular en piel y mucosas. Posee acción antioxidante.", null),
                    new NutrientEntity(null, "Vainillina", "Compuesto quimico que proporciona el sabor y aroma caracteristicos de la vainilla.", "La vainillina es el principal componente aromático de la vainilla. Se utiliza como saborizante natural en alimentos y cosmética.", null),
                    new NutrientEntity(null, "Vitamina E", "Vitamina liposoluble con propiedades antioxidantes.", "La vitamina E protege membranas y lipoproteínas de la peroxidación lipídica. Mejora la respuesta inmune y previene la agregación plaquetaria.", null),
                    new NutrientEntity(null, "acido Graso Omega 6", "Tipo de acido graso esencial.", "El ácido linoleico es un omega 6 precursor de eicosanoides proinflamatorios. Debe equilibrarse con omega 3 mediante una dieta adecuada.", null),
                    new NutrientEntity(null, "Sodio", "Mineral esencial necesario para el equilibrio de liquidos y la funcion nerviosa.", "El sodio es el principal catión extracelular. Participa en el balance hídrico, contracción muscular y transmisión nerviosa. Su exceso eleva la presión arterial.", null),
                    new NutrientEntity(null, "Fosfolipidos", "Tipo de lipido esencial que forma parte de las membranas celulares.", "Los fosfolípidos forman la doble capa lipídica de las membranas celulares. Participan en la señalización celular y metabolismo.", null),
                    new NutrientEntity(null, "Resveratrol", "Polifenol con propiedades antioxidantes encontrado en ciertos alimentos como el vino tinto.", "El resveratrol neutraliza radicales libres y exhibe propiedades antiinflamatorias y anticancerígenas en estudios con animales y células.", null),
                    new NutrientEntity(null, "Antioxidantes", "Compuestos que protegen las celulas del danio oxidativo.", "Los antioxidantes como vitamina C, E, carotenoides y polifenoles previenen daño a biomoléculas ocasionado por especies reactivas de oxígeno.", null)
                );
            ...
            if(categoryFoodRepository.count() == 0) {
                categories = Arrays.asList(
                    ...
                    new CategoryFoodEntity(null, "Lácteos", "Los lácteos provienen de la leche de vaca u otros mamíferos. Incluyen leche, queso, yogurt, etc.", "Fuente de calcio, vitaminas A, D y B12. Ayudan a mantener huesos y dientes sanos.", "No recomendados para intolerantes a la lactosa. Alto aporte de grasas saturadas en algunos derivados.", null),
            ...
            if(foodRepository.count() == 0) {
                foods = Arrays.asList(
                    new FoodEntity(null, "Pollo", "Carne magra rica en proteínas, baja en grasa. Fuente de vitaminas B6, B12, zinc, hierro.", PrivacityEnum.PUBLIC, false, "https://www.fatsecret.es/calor%C3%ADas-nutrici%C3%B3n/gen%C3%A9rico/pechuga-de-pollo-sin-piel", null, getCategoryByName(categories, "Carnes y Aves"), null, null),
                    new FoodEntity(null, "Arroz", "Grano rico en almidón que constituye la base de la alimentación de gran parte del mundo. Fuente de hidratos de carbono complejos y fibra.", PrivacityEnum.PUBLIC, false, "https://bing.com/search?q=Arroz+blanco%2c+cocido+site%3afatsecret.es", null, getCategoryByName(categories, "Granos"), null, null),
                    new FoodEntity(null, "Brocoli", "Verdura crucífera rica en vitaminas C, K, folatos, potasio y fibra. Posee propiedades anticancerígenas.", PrivacityEnum.PUBLIC, false, "https://bing.com/search?q=Brocoli+cocido+site%3afatsecret.es", null, getCategoryByName(categories, "Vegetales"), null, null),  
                    new FoodEntity(null, "Platano", "Fruta tropical rica en hidratos de carbono, potasio, vitamina B6 y fibra dietética. Aporta rápida energía.", PrivacityEnum.PUBLIC, false, "https://www.fatsecret.es/calor%C3%ADas-nutrici%C3%B3n/gen%C3%A9rico/pl%C3%A1tano-maduro", null, getCategoryByName(categories, "Frutas"), null, null),
                    new FoodEntity(null, "Lentejas", "Legumbre rica en proteínas, hidratos de carbono complejos, fibra, hierro, folatos y potasio.", PrivacityEnum.PUBLIC, false, "https://bing.com/search?q=Lentejas+cocidas+site%3afatsecret.es", null, getCategoryByName(categories, "Granos"), null, null),
                    new FoodEntity(null, "Salmon", "Pescado azul rico en proteínas, grasas omega 3 y vitaminas A, D, B6, B12. Beneficioso para el corazón y el cerebro.", PrivacityEnum.PUBLIC, false, "https://bing.com/search?q=Arroz+blanco%2c+cocido+site%3afatsecret.es", null, getCategoryByName(categories, "Pescados y Mariscos"), null, null),
                    new FoodEntity(null, "Leche", "Bebida láctea rica en proteínas, calcio, vitaminas A y B12. Fortalece huesos y dientes.", PrivacityEnum.PUBLIC, false, "https://www.fatsecret.es/calor%C3%ADas-nutrici%C3%B3n/gen%C3%A9rico/leche-(leche-entera)", null, getCategoryByName(categories, "Lacteos"), null, null),
                    new FoodEntity(null, "Pescado", "Alimento rico en proteínas, grasas saludables y vitaminas del complejo B. Excelente para el cerebro y corazón.", PrivacityEnum.PUBLIC, false, "https://www.fatsecret.es/calor%C3%ADas-nutrici%C3%B3n/gen%C3%A9rico/filete-de-pescado-al-horno-o-la-parrilla?portionid=50627&portionamount=100,000", null, getCategoryByName(categories, "Pescados y Mariscos"), null, null),
                    new FoodEntity(null, "Cebolla", "Bulbo vegetal con compuestos azufrados, vitamina C, flavonoides y fibra. Propiedades anticancerígenas.", PrivacityEnum.PUBLIC, false, "https://www.fatsecret.es/calor%C3%ADas-nutrici%C3%B3n/gen%C3%A9rico/cebollas-rojas?portionid=340024&portionamount=1,000", null, getCategoryByName(categories, "Vegetales"), null, null),
                    new FoodEntity(null, "Limon", "Fruta cítrica rica en vitamina C y flavonoides. Ayuda a depurar el organismo y fortalece defensas.", PrivacityEnum.PUBLIC, false, "https://www.fatsecret.es/calor%C3%ADas-nutrici%C3%B3n/gen%C3%A9rico/lim%C3%B3n", null, getCategoryByName(categories, "Frutas"), null, null),
                    new FoodEntity(null, "Aji", "Picante natural rico en capsaicina. Estimula el metabolismo y tiene propiedades anticancerígenas.", PrivacityEnum.PUBLIC, false, "https://www.fatsecret.es/calor%C3%ADas-nutrici%C3%B3n/gen%C3%A9rico/aj%C3%AD-verde", null, getCategoryByName(categories, "Especias"), null, null),
                    new FoodEntity(null, "Carne", "Alimento rico en proteínas, hierro y vitaminas del grupo B. Debe consumirse con moderación por su alto contenido de grasa.", PrivacityEnum.PUBLIC, false, "https://www.fatsecret.es/calor%C3%ADas-nutrici%C3%B3n/gen%C3%A9rico/filete-de-ternera?portionid=50263&portionamount=200,000", null, getCategoryByName(categories, "Carnes y Aves"), null, null),
                    new FoodEntity(null, "Papa", "Tubérculo rico en hidratos de carbono, vitaminas del grupo B, potasio y vitamina C. Aporta energía de fácil digestión.", PrivacityEnum.PUBLIC, false, "https://www.fatsecret.es/calor%C3%ADas-nutrici%C3%B3n/gen%C3%A9rico/papa", null, getCategoryByName(categories, "Vegetales"), null, null),
                    new FoodEntity(null, "Tomate", "Fruto carnoso rico en licopeno, vitamina C y potasio. Posee propiedades antioxidantes y anticancerígenas.", PrivacityEnum.PUBLIC, false, "https://www.fatsecret.es/calor%C3%ADas-nutrici%C3%B3n/hacendado/tomate-frito/100g", null, getCategoryByName(categories, "Vegetales"), null, null),
                    new FoodEntity(null, "Ajo", "Bulbo conocido por sus propiedades medicinales, antibacterianas y antioxidantes. Rico en vitaminas B6 y C.", PrivacityEnum.PUBLIC, false, "https://www.fatsecret.es/calor%C3%ADas-nutrici%C3%B3n/gen%C3%A9rico/ajo-picado", null, getCategoryByName(categories, "Especias"), null, null),
                    new FoodEntity(null, "Queso", "Derivado lácteo rico en proteínas, calcio, fósforo y vitaminas A y B12. Alto contenido de grasas saturadas.", PrivacityEnum.PUBLIC, false, "https://www.fatsecret.es/calor%C3%ADas-nutrici%C3%B3n/gen%C3%A9rico/queso-cheddar", null, getCategoryByName(categories, "Lacteos"), null, null),
                    new FoodEntity(null, "Lechuga", "Verdura de hoja verde rica en vitaminas A, C, K y folatos. Muy baja en calorías.", PrivacityEnum.PUBLIC, false, "https://www.fatsecret.es/calor%C3%ADas-nutrici%C3%B3n/gen%C3%A9rico/lechuga-iceberg-(incluye-los-arrepollos)", null, getCategoryByName(categories, "Vegetales"), null, null),
                    new FoodEntity(null, "Aceituna", "Fruto del olivo rico en grasas monoinsaturadas y compuestos bioactivos. Fuente de vitamina E.", PrivacityEnum.PUBLIC, false, "https://www.fatsecret.es/calor%C3%ADas-nutrici%C3%B3n/gen%C3%A9rico/aceitunas-verdes", null, getCategoryByName(categories, "Frutas"), null, null),
                    new FoodEntity(null, "Huevo", "Alimento rico en proteínas de alto valor biológico, vitaminas y minerales. Contiene colesterol.", PrivacityEnum.PUBLIC, false, "https://www.fatsecret.es/calor%C3%ADas-nutrici%C3%B3n/gen%C3%A9rico/huevo-cocido", null, getCategoryByName(categories, "Huevos"), null, null),
                    new FoodEntity(null, "Mayonesa", "Salsa emulsionada a base de huevo y aceite. Rico en grasas, debe consumirse con moderación.", PrivacityEnum.PUBLIC, false, "https://www.fatsecret.es/calor%C3%ADas-nutrici%C3%B3n/search?q=Mayonesa+Casera", null, getCategoryByName(categories, "Salsas y Endulzantes"), null, null),
                    new FoodEntity(null, "Palta", "Fruto tropical rico en grasas monoinsaturadas y vitaminas B, C, E y K. Beneficioso para el corazón.", PrivacityEnum.PUBLIC, false, "https://www.fatsecret.es/calor%C3%ADas-nutrici%C3%B3n/gen%C3%A9rico/aguacates?portionid=32968&portionamount=0,500", null, getCategoryByName(categories, "Frutas"), null, null),
                    new FoodEntity(null, "Cecina", "Carne de res salada y deshidratada. Rico en proteínas. Alto contenido de sodio.", PrivacityEnum.PUBLIC, false, "https://www.fatsecret.es/calor%C3%ADas-nutrici%C3%B3n/search?q=Cecina+de+Pecho+de+Res+%28Salados%2c+Cocidos%29", null, getCategoryByName(categories, "Carnes y Aves"), null, null),
                    new FoodEntity(null, "Gallina", "Carne magra rica en proteínas, baja en grasa. Fuente de vitaminas B6, B12, zinc, hierro.", PrivacityEnum.PUBLIC, false, "https://www.fatsecret.es/calor%C3%ADas-nutrici%C3%B3n/gen%C3%A9rico/pollo-asado", null, getCategoryByName(categories, "Carnes y Aves"), null, null),
                    new FoodEntity(null, "Vino", "Bebida alcohólica derivada de la uva. Debe consumirse con moderación por su contenido de alcohol.", PrivacityEnum.PUBLIC, false, "https://www.fatsecret.es/calor%C3%ADas-nutrici%C3%B3n/alimentos/vino-tinto", null, getCategoryByName(categories, "Bebidas"), null, null),
                    new FoodEntity(null, "Azucar", "Edulcorante refinado rico en calorías. Su consumo excesivo puede provocar sobrepeso y caries.", PrivacityEnum.PUBLIC, false, "https://www.fatsecret.es/calor%C3%ADas-nutrici%C3%B3n/azucarera/az%C3%BAcar-blanco/1-cucharadita", null, getCategoryByName(categories, "Salsas y Endulzantes"), null, null),
                    new FoodEntity(null, "Claras de huevo", "Parte del huevo rica en proteínas de alto valor biológico y baja en grasa. Muy versátil en preparaciones.", PrivacityEnum.PUBLIC, false, "https://www.fatsecret.es/calor%C3%ADas-nutrici%C3%B3n/gen%C3%A9rico/clara-de-huevo", null, getCategoryByName(categories, "Huevos"), null, null),
                    new FoodEntity(null, "Esencia de vainilla", "Extracto natural que se usa para dar aroma y sabor dulce a preparaciones.", PrivacityEnum.PUBLIC, false, "https://www.fatsecret.es/calor%C3%ADas-nutrici%C3%B3n/gen%C3%A9rico/extracto-de-vainilla", null, getCategoryByName(categories, "Especias"), null, null),
                    new FoodEntity(null, "Manjarblanco", "Preparación típica chilena a base de leche y azúcar. Rico en calorías por su alto contenido de azúcares.", PrivacityEnum.PUBLIC, false, "https://www.myfitnesspal.com/es/food/calories/manjar-blanco-1158827675", null, getCategoryByName(categories, "Dulces"), null, null)
                );
            ...
            if(userRepository.count() == 0) {
                ...
                users = Arrays.asList(
                    new UserEntity(null, "kiridepapel", "40se02j7", "brian@gmail.com", "Brian", "Uceda", "https://ssl.gstatic.com/images/branding/product/1x/avatar_circle_blue_512dp.png", false, null, null, null, null, getRandomObjectives(objectives, 7), null, null, new HashSet<>(Arrays.asList(ADMIN, USER))),
                    new UserEntity(null, "heatherxvalencia", "mongolita123", "heather@gmail.com", "Heather", "Valencia", "https://ssl.gstatic.com/images/branding/product/1x/avatar_circle_blue_512dp.png", false, null, null, null, null, getRandomObjectives(objectives, 6), null, null, new HashSet<>(Arrays.asList(USER))),
                    new UserEntity(null, "whoami", "1_^+=1,.22", "willy@gmail.com", "Willy", "Samata", "https://ssl.gstatic.com/images/branding/product/1x/avatar_circle_blue_512dp.png", false, null, null, null, null, getRandomObjectives(objectives, 2), null, null, new HashSet<>(Arrays.asList(USER))),
                    new UserEntity(null, "nayde", "gatitobello123", "nayde@gmail.com", "Naydeline", "Duran", "https://ssl.gstatic.com/images/branding/product/1x/avatar_circle_blue_512dp.png", false, null, null, null, null, getRandomObjectives(objectives, 5), null, null, new HashSet<>(Arrays.asList(USER))),
                    new UserEntity(null, "gabi", "prolenvalorant", "gabriela@gmail.com", "Gabriela", "Reyes", "https://ssl.gstatic.com/images/branding/product/1x/avatar_circle_blue_512dp.png", false, null, null, null, null, getRandomObjectives(objectives, 5), null, null, new HashSet<>(Arrays.asList(USER))),
                    new UserEntity(null, "impresora", "lenovo", "edson@gmail.com", "Edson", "Linares", "https://ssl.gstatic.com/images/branding/product/1x/avatar_circle_blue_512dp.png", false, null, null, null, null, getRandomObjectives(objectives, 2), null, null, new HashSet<>(Arrays.asList(USER)))
                );
                userRepository.saveAll(users);
            }
            if(recipeRepository.count() == 0) {
                recipes = Arrays.asList(
                    new RecipeEntity(null, "Arroz con pollo", "Plato sabroso que combina el arroz con trozos de pollo y verduras.", "Cocinar el arroz y rehogar el pollo con las verduras. Mezclar y sazonar al gusto.", "Rico en carbohidratos y proteínas. Nutritivo y energético.", "Alto contenido calórico si se excede en porciones.", 4.6, PrivacityEnum.PUBLIC, false, null, null, null),
                    new RecipeEntity(null, "Ceviche", "Plato típico peruano a base de pescado marinado en jugo de limón. Se sirve con cebolla, ají y choclo.", "Marinar el pescado cortado en cubos con jugo de limón. Agregar cebolla, ají y choclo. Sazonar al gusto.", "Rico en proteínas. El limón ayuda a la digestión. Bajo en calorías.", "No recomendado en embarazadas por riesgo de parasitosis. El exceso de limón puede irritar el estómago.", 5.0, PrivacityEnum.PUBLIC, false, null, null, null),
                    new RecipeEntity(null, "Lomo saltado", "Plato sabroso de la cocina peruana hecho con tiras de lomo salteadas con tomate, cebolla y ají.", "Saltear la carne con aceite y especias. Agregar cebolla, tomate y ají. Servir con papas fritas.", "Carne magra y vegetales frescos. Rico en proteínas y vitaminas.", "Alto contenido de sodio por el uso de soya y ajinomoto. Las papas fritas aportan grasas.", 5.0, PrivacityEnum.PUBLIC, false, null, null, null),
                    new RecipeEntity(null, "Tacacho con cecina", "Plato típico de la selva hecho con plátanos verdes, cecina y salsa criolla.", "Cocinar y machacar los plátanos. Freír y hacer tortillas. Acompañar con cecina y salsa criolla.", "Combinación de carbohidratos y proteínas. La cecina aporta hierro.", "Alto contenido calórico. La cecina tiene mucho sodio. Los plátanos verdes pueden ser indigestos.", 4.2, PrivacityEnum.PUBLIC, false, null, null, null),
                    new RecipeEntity(null, "Papa a la huancaina", "Entrante cremoso de papas sancochadas bañadas en salsa de ají amarillo y queso fresco.", "Cocer las papas con cáscara. Pelar y cortar en rodajas. Bañar con salsa de ají amarillo y queso. Decorar con huevo duro y aceituna.", "Combinación nutritiva de papa, queso, huevo y ají. Rico en vitaminas.", "Alto contenido calórico por las cremas y aceites. El exceso de ají puede irritar el estómago.", 4.1, PrivacityEnum.PUBLIC, false, null, null, null),
                    new RecipeEntity(null, "Causa limenia", "Plato frío hecho con una mezcla de mashed potato y pollo desmenuzado.", "Cocinar y triturar las papas con aceite. Agregar pollo desmenuzado y limón. Decorar con mayonesa, aceituna y huevo.", "Aporte balanceado de carbohidratos y proteínas. Sabor agradable.", "Alto contenido calórico por las cremas y aceites. La mayonesa tiene colesterol.", 3.6, PrivacityEnum.PUBLIC, false, null, null, null),
                    new RecipeEntity(null, "Aji de gallina", "Plato representativo a base de trozos de pollo en una salsa cremosa de ají amarillo.", "Cocer y deshilachar el pollo. Cocinar la salsa con ají amarillo y especias. Mezclar con el pollo y crema. Servir con arroz.", "Salsa cremosa y sabrosa. Buena fuente de proteínas.", "Alto contenido calórico por la crema de leche. Picante para algunos paladares.", 4.7, PrivacityEnum.PUBLIC, false, null, null, null),
                    new RecipeEntity(null, "Suspiro limenio", "Postre criollo hecho con manjarblanco y merengue de claras de huevo.", "Batir las claras a punto de nieve con azúcar. Integrar con el manjarblanco. Decorar con ralladura de limón.", "Postre ligero con contrasts de sabores. Bajo en calorías.", "Alto contenido de azúcar. No recomendado para diabéticos ni intolerantes a la lactosa.", 2.2, PrivacityEnum.PUBLIC, false, null, null, null)
                );
