...
import xyz.brianuceda.monolithfood_backend.dtos.activitylevel.ActivityLevelDTO;
import xyz.brianuceda.monolithfood_backend.dtos.activitylevel.ActivityLevelsResponseDTO;
import xyz.brianuceda.monolithfood_backend.dtos.auth.AuthResponseDTO;
import xyz.brianuceda.monolithfood_backend.dtos.fitnessinfo.FitnessInfoDTO;
import xyz.brianuceda.monolithfood_backend.dtos.fitnessinfo.FitnessInfoResponseDTO;
import xyz.brianuceda.monolithfood_backend.dtos.general.ResponseDTO;
import xyz.brianuceda.monolithfood_backend.dtos.objectives.ObjectiveDTO;
import xyz.brianuceda.monolithfood_backend.dtos.objectives.ObjectivesResponseDTO;
import xyz.brianuceda.monolithfood_backend.dtos.reports.MacrosPerDays;
import xyz.brianuceda.monolithfood_backend.dtos.reports.MacrosPerWeek;
...
import xyz.brianuceda.monolithfood_backend.repositories.ActivityLevelRepository;
import xyz.brianuceda.monolithfood_backend.repositories.ObjectiveRepository;
import xyz.brianuceda.monolithfood_backend.repositories.UserFitnessInfoRepository;
...
public class UserFitnessInfoService {
    ...
    public ResponseDTO setActivityLevel(String username, String activityLevelName) {
        ...
        if (response.getStatusCode() == 200) {
            String profileStage = jwtUtils.determineProfileStage(user);
            String generatedToken = jwtUtils.genToken(user, profileStage);
