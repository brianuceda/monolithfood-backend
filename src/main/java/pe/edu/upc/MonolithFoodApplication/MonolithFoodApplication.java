    ...
    public CommandLineRunner initData(
        ...
        return args -> {
            ...
            if(userRepository.count() == 0) {
                ...
                users = Arrays.asList(
                    new UserEntity(null, "kiridepapel", "$2a$10$8YYL6YTawu99l5vFqGTKI.ul/1JoG9FJ9z2HkPRFv6znEb39jvTIe", "brian@gmail.com", "Brian Uceda", "https://i.ibb.co/t8D3Yz0/bnh.jpg", null, false, false, "179.6.5.75", null, null, null, null, null, getRandomObjectives(objectives, 7), null, null, null, new HashSet<>(Arrays.asList(ADMIN, USER))),
