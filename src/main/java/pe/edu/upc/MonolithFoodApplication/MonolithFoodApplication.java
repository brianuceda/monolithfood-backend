        ...
        return args -> {
            ...
            if(userPersonalInfoRepository.count() == 0) {
                ...
                for (UserEntity user : users) {
                    ...
                    // Ingesta calorica diaria aleatoria entre 0 y 1000
                    double daily_caloric_intake =  0.0 + rand.nextInt(1000);
                    ActivityLevelEntity activityLevel = activityLevels.get(rand.nextInt(activityLevels.size()));
                    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                    UserPersonalInfoEntity userPF = new UserPersonalInfoEntity(null, gender, birthdate, height, weight, daily_caloric_intake , activityLevel, user);
