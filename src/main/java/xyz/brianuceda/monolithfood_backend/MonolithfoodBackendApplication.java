package xyz.brianuceda.monolithfood_backend;
...
import xyz.brianuceda.monolithfood_backend.entities.*;
import xyz.brianuceda.monolithfood_backend.repositories.*;
...
public class MonolithfoodBackendApplication {

	public static void main(String[] args) {
		SpringApplication.run(MonolithfoodBackendApplication.class, args);
	}
